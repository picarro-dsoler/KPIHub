...
output_dict={
    ...
    'InstantanoeusEmission': ['SCFH / Km', 'Emission rate per Km of Asset Covered', 'EmissionRate / DistributionPipeCoveredKm'],
    ...
    'InstantaneousRepEmissionB0LPM': ['LPM / Km', 'B0 representative emission rate per Km of Asset Covered', 'InstantaneousRepEmissionB0 * 0.471947 / DistributionPipeCoveredKm'],
    'InstantaneousRepEmissionBm1': ['SCFH / Km', 'B-1 representative emission rate per Km of Asset Covered', 'Bm1RepEmissionRate / DistributionPipeCoveredKm'],
    'InstantaneousRepEmissionBm1LPM': ['LPM / Km', 'B-1 representative emission rate per Km of Asset Covered', 'InstantaneousRepEmissionBm1 * 0.471947 / DistributionPipeCoveredKm'],
    'InstantaneousRepEmissionBm2': ['SCFH / Km', 'B-2 representative emission rate per Km of Asset Covered', 'Bm2RepEmissionRate / DistributionPipeCoveredKm'],
    'InstantaneousRepEmissionBm2LPM': ['LPM / Km', 'B-2 representative emission rate per Km of Asset Covered', 'InstantaneousRepEmissionBm2 * 0.471947 / DistributionPipeCoveredKm'],
