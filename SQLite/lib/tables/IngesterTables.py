...
KPI_Utilization.add_column(DBColumn('SunriseHour', datatype='int'))
KPI_Utilization.add_column(DBColumn('SunsetHour', datatype='int'))
...
KPI_EmissionSourceSummary.add_column(DBColumn('EmissionRateLPM', datatype='uniqueidentifier'))
...
KPI_EmissionSourceSummary.add_column(DBColumn('B0RepEmissionRateLPM', datatype='float'))
KPI_EmissionSourceSummary.add_column(DBColumn('B1RepEmissionRateLPM', datatype='float'))
KPI_EmissionSourceSummary.add_column(DBColumn('Bm1RepEmissionRateLPM', datatype='float'))
KPI_EmissionSourceSummary.add_column(DBColumn('Bm2RepEmissionRateLPM', datatype='float'))
KPI_EmissionSourceSummary.add_column(DBColumn('B0RepEmissionRate', datatype='float'))
KPI_EmissionSourceSummary.add_column(DBColumn('B1RepEmissionRate', datatype='float'))
KPI_EmissionSourceSummary.add_column(DBColumn('Bm1RepEmissionRate', datatype='float'))
KPI_EmissionSourceSummary.add_column(DBColumn('Bm2RepEmissionRate', datatype='float'))
...
KPI_SurveySummary.add_column(DBColumn('TotalSegmentsInSurvey', datatype='int'))
